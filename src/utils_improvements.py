...
def get_model_params(lr, first_additional_triplet, second_additional_triplet,  reg_loss, additional_triplets_loss, dropout_encoder, dropout_decoder, additional_dropout, encoder_hidden_size, decoder_hidden_size, depth_transformer, momentum,num_classes):
    # Model parameters
    params_model = dict()
    ...
    params_model['num_classes']=num_classes
    return params_model
